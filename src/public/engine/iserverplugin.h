...
public:
	...
	virtual void			ClientFullyConnect(void* pEdict) = 0; // p2port/emulsion: moved for p2 compat

	// Client is going active
	virtual void			ClientActive( edict_t *pEntity ) = 0;

	// Client is fully connected ( has received initial baseline of entities )
	virtual void			ClientFullyConnect( edict_t *pEntity ) = 0; // p2port: This is kept in Emulsion for "asw vtable pos"
