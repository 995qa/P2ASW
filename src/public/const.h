...
#define INVALID_STEAM_VACBANSTATE "oh god damn holy shit you fucked up big time (VAC banned from secure server)\n"
...
#define FL_UNPAINTABLE			(1<<20) // Unpaintable entities!
#else
